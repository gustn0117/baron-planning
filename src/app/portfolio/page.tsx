  ...
  return (
    <>
      ...
      <div className="portfolio-section-title">
        <p className="portfolio-subtitle">자신의 분야 최고에 도전하는</p>
        <h2 style={{ fontSize: '12px', letterSpacing: '4px', textTransform: 'uppercase' }}>
          <span style={{ color: 'var(--text-muted)', fontWeight: 300 }}>our</span>{' '}
          <span style={{ fontWeight: 700, color: 'var(--dark)' }}>PROJECT</span>
        </h2>
      </div>
