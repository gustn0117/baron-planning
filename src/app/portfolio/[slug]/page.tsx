...
const projectsData: Record<string, ProjectData> = {
  ...
  'brownstone-yeowol': {
    ...
    galleryImgs: ['/images/result/detail/brownstone-yeowol-showroom.png'],
    design2dImgs: ['/images/result/detail/brownstone-yeowol-gallery.jpg'],
    ...
    parking: '144대',
    videos: [
      { title: '외부 조감 단지 영상', youtubeId: 'wzkrrpiqS7M' },
      { title: '3D 인테리어 영상', youtubeId: 'rD-kk75Scu8' },
    ],
