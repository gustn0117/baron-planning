...
const projectsData: Record<string, ProjectData> = {
  ...
  honorsville: {
    ...
    galleryImgs: ['/images/result/detail/honorsville-gallery.png'],
  ...
  rogevian: {
    ...
    galleryImgs: ['/images/result/detail/rogevian-gallery1.png', '/images/result/detail/rogevian-gallery2.png'],
    location: '충북 청주시 비하동',
    structure: '철근콘크리트구조',
    landArea: '-',
    buildArea: '-',
