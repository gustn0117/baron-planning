...
const projectsData: Record<string, ProjectData> = {
  ...
  honorsville: {
    ...
    galleryImgs: ['/images/result/detail/honorsville-gallery2.jpg', '/images/result/detail/honorsville-gallery.png'],
  ...
  'castle-familier': {
    ...
    logoImg: '/images/result/detail/castle-familier-logo.png',
  ...
  granviastar: {
    ...
    logoImg: '/images/result/detail/granviastar-logo.png',
  ...
  'gwanggyo-rogevian': {
    ...
    logoImg: '/images/result/detail/gwanggyo-logo.png',
  ...
  'first-plaza': {
    ...
    logoImg: '/images/result/detail/first-plaza-logo.png',
